...
//    y: 100
   ...
   DropArea {
        ...
        onDropped: {
            ...
            //dropCircleText.text = dragTarget.drag.source.displayText
            dropCircleText.text = dragTarget.drag.source._possibleAnswer

            console.log("DROPPED")
            objectDroppedIn = true
        }

        onExited: {

            if (objectDroppedIn == false) {
                    dropCircleText.text = "...."
            }

            objectDroppedIn = false
    ...
    Image {
        ...
        states: State {
                    ...
                    PropertyChanges {
                        ...
                        width:
                            imgWidth ? imgWidth * dropCircle.parent.width : (dropCircle.parent.source == "" ?
